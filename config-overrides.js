...
module.exports = override(
  ...
  addLessLoader({
    ...
    modifyVars: {
      ...
      '@btn-default-color': Styles.colors[8],
      '@radio-button-bg': Styles.colors[0],
      '@radio-button-color': Styles.colors[1],
      '@radio-button-checked-bg': Styles.colors[8],
      '@radio-button-checked': Styles.colors[1],
      '@radio-dot-color': Styles.colors[8],
      '@radio-button-hover-color': Styles.colors[8],
      '@checkbox-color': Styles.colors[7],
      '@checkbox-check-color': Styles.colors[8],
